...
import com.example.loginflow.components.CheckBoxComponents
    ...
    Surface(
        ...
        Column(
            ...
            MyTextFiledComponent(
                ...
                painterResource = painterResource(id = R.drawable.outline_mail_outline_24)
            )
            ...
            CheckBoxComponents(value = stringResource(id = R.string.terms_and_conditions),
                onTextSelected = {
                    PostOfficeAppRouter.navigateTo(Screen.TermsAndConditionScreens)
                })
